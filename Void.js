class Void{
  constructor(pos) {
    ...
    this.maxF = 0.1; // Maximale Kraft des Boids
    this.maxV = 10; // Maximale Geschwindigkeit des Boids
    this.col = color(255,10,10); // Farbe des Boids
    this.boidlength = random(20,25); // Länge des Boids
  ...
  flock(boids) {
    ...
    alignment.mult(al); // Jeweils mit einem ;
    avoid.mult(0.2);
